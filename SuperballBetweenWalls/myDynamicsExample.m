function myDynamicsExample(tensStruct1, dynamicsPlot1, displayTimeInterval)
...
%Check error flag and stop simulation
if dynamicsPlot.plotErrorFlag==1
    %This throws an error that stops the simulation (suboptimal)
    stop;
end
